...
if (!empty($_GET['username']) && $_GET['username'] != "") {
	...
	<head>
		<title>Peminjaman | Peminjaman Barang</title>
			...
			<div class='row'>
				...
				<div class="col-md-4 form-register-container">
					...
					<form action="request-barang.php" method="post">
						...
						<input class="form-control" type="" name="username" required value="<?php echo $_GET['username']; ?>"
							readonly>
						...
						<button type="submit" name="request-pinjam" class="btn btn-success"
