                ...
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_barang = $conn->query("SELECT SUM(stok_barang) AS stok FROM tbl_barang");
                ...
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_request = $conn->query("SELECT COUNT(*) AS total_req_pinjam FROM tbl_request");
                                    $total_request = $query_request->fetch_assoc();
                ...
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    $query_barang_pinjam = $conn->query("SELECT SUM(jml_barang) AS jml_barnag FROM tbl_pinjam");
                                    $total_barang_pinjam = $query_barang_pinjam->fetch_assoc();
