        ...
        if(isset($file_name) && !empty($file_name)){
            if(($extension == "jpg" || $extension == "jpeg" || $extension == "gif" || $extension == "png") && ($file_type == "image/jpeg" || $file_type == "image/png" || $file_type=="image/gif") && $file_size <= $max_size){
                ...
                if (move_uploaded_file($tmp_name, $location.$file_name)) {
                    $insert_query = "INSERT INTO tbl_barang (nama_barang, gambar_barang, stok_barang) VALUES (?, ?, ?)";
                    $stmt = $conn->prepare($insert_query);
                    $stmt->bind_param("ssi", $nama_barang, $file_name, $stok_barang);
                    if($stmt->execute()){
                        ...
                        <div class="card">
                          ...
                          <form class="card-body card-block" action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama" name="nama_barang" placeholder="contoh: Kamera" class="form-control"> 
                            </div>
                            <div class="form-group">
